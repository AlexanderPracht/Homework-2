...
Here, we’ve created two confidence intervals, one using our dataset, and the other via bootstrapping for mean delta. The bootstrap method generated 1000 samples from our dataset with replacement, in order to approximate the distribution and estimate sample-to-sample variability. The bootstrap confidence interval shows us that we can be 95% confident that the true average delta between 2011-present lies between 0.917 and 1.02.
