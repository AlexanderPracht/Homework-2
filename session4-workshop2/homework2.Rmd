...
countries_data <- full_join(region_worldbank, life_expectancy_tidy, by = c("country", "date"))
...
ggplot(countries_region_mortality, aes(x=date,y = mean_mortality ))+
  ...
  labs(x="Date",y = " Mortality Per 1000 for Under 5",
       title= "Declination of Mortality",
       subtitle = " Mortality rate for under 5 changed by region")
```
