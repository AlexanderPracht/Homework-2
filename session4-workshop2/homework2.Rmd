...
ggplot(bike_data3)+
  ...
  geom_line(aes(month, avg_15_19, group=1), color = "blue")+
   facet_wrap(~year)+
  geom_ribbon(aes(month, ymin = pmin(bikes_per_month,avg_15_19), ymax= avg_15_19,group = year,alpha=0.01),show.legend = FALSE,fill="red",size=0.0001)+
  geom_ribbon(aes(month, ymin = pmin(bikes_per_month,avg_15_19), ymax= bikes_per_month,group = year,alpha=0.01),show.legend = FALSE,fill="green",size=0.0001)
