...
ggplot(bike_data3)+
  ...
  geom_line(aes(month, avg_15_19, group=1), color = "blue")+
   facet_wrap(~year)+
  geom_ribbon(aes(month, ymin = pmin(bikes_per_month,avg_15_19), ymax= avg_15_19,group = year),show.legend = FALSE,fill="red",alpha=0.2)+
  geom_ribbon(aes(month, ymin = pmin(bikes_per_month,avg_15_19), ymax= bikes_per_month,group = year),show.legend = FALSE,fill="green", alpha=0.2)+
  labs(title="Monthly changes in Tfl bike rentals", subtitle = "Change from monthly average shown in blue \nand calculated between 2015-2019", y="Bike rentals", x=NULL)+
