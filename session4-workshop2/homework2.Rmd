...
We start with the graphs:
```{r covid_challenge, echo=FALSE"}
graph1_deaths <- covid_data %>% 
  select(sex, age_group, medcond_yn, death_yn) %>% #we remove the missing entries for the selected variablbes
