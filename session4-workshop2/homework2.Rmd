...
>>>>>>> 5a792461bc93f467cb764c7442aba72ef40abb25

We uses left_join(), because left_join() enables to preserve the original observations even when there isn't a match. What's more, left_join() is faster than merge(). The worldbank_data has the most entries, so left join life_expectancy and then hiv data to it.
```{r}
hiv_tidy <- hiv %>% 
